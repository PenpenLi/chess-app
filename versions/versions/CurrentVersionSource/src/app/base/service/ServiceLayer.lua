...
C.RESOURCE_BINDING = {
    ...
    contact_tab_Checked = {path="box_img.contact_tab_Checked"},
    common_tab_Checked = {path="box_img.common_tab_Checked"},
}
C.webview = nil
...
function C:showTabIndex( index,fromShow )
    ...
    self.contact_tab_Checked:setVisible(index==1)
	self.common_tab_Checked:setVisible(index==2)
end
