...
Money.CS_PAY = 49	--请求支付地址
Money.SC_PAY = 50	--请求支付返回
Money.CS_VIP_PAY_LIST_P = 51	--请求VIP支付列表
Money.SC_VIP_PAY_LIST_P = 52	--请求VIP支付列表返回
--endregion
...
--百家乐游戏消息
Game.CS_GAME_BJL_ALLINFO_P   = 123                 -- 请求百家乐全部桌面信息
Game.SC_GAME_BJL_ALLINFO_P   = 124                    -- 返回百家乐全部桌面信息
...
--region 活动任务
Task = {}
Task.CS_UPDATE_TASK_LIST=0				--更新任务列表信息
Task.SC_UPDATE_TASK_LIST=1				--更新任务列表信息
Task.CS_GET_TASK_REWARD=2             	--领取任务奖励
Task.SC_GET_TASK_REWARD=3             	--领取任务奖励返回
