...
local C = class("JSMJRoomScene",SceneBase)
JSMJRoomScene = C
C.jsmjHelpLayer = nil
-- 资源名
C.RESOURCE_FILENAME = "base/JSMJRoom.csb"
...
function C:initialize()
    ...
    self.node_help:setVisible(false)
    ...
    self.girlAni:setScaleX(0.48)
    self.girlAni:setScaleY(0.48)
    ...
    self.label_0:setString(10/MONEY_SCALE)       --体验房底注
    self.label_1:setString(2000/MONEY_SCALE)       --体验房准入
    self.label_2:setString(100/MONEY_SCALE)       --初级房底注
    self.label_3:setString(5000/MONEY_SCALE)       --初级房准入
    self.label_4:setString(500/MONEY_SCALE)       --中级房底注
    self.label_5:setString(20000/MONEY_SCALE)       --中级房准入
    self.label_6:setString(1000/MONEY_SCALE)       --高级房底注
    self.label_7:setString(50000/MONEY_SCALE)       --高级房准入
...
function C:loadQZNNGirlAnimation()
	local strAnimName ="base/animation/skeleton/jsmj/ermj_effect_hall_girl_ske"
...
function C:loadQZNN01Animation()
	local strAnimName ="base/animation/skeleton/jsmj/ermj_effect_room1_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN02Animation()
	local strAnimName ="base/animation/skeleton/jsmj/ermj_effect_room2_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN03Animation()
	local strAnimName ="base/animation/skeleton/jsmj/ermj_effect_room3_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN04Animation()
	local strAnimName ="base/animation/skeleton/jsmj/ermj_effect_room4_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
