...
function C:onCreate()
	...
	self.passwordEditBox:setContentSize(cc.size(240,70))
    local label = self.passwordEditBox:getChildByTag(10000)
    label:setContentSize(cc.size(214,70))
    label:setPosition(cc.p(76,30))
...
function C:createEditBox( placeholder, inputMode )
	...
	local editBox = ccui.EditBox:create(cc.size(373,70),bg,bg,bg)
	...
	label:setTag(10000)
	label:setContentSize(cc.size(373,70))
	label:setPosition(cc.p(86,30))
