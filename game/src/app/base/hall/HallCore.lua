...
function C:registerEvents()
    ...
    self.configsResultHandler = function(s) 
        ...
        self.rechargeLayer:show(s,self.showIndex) 
--        else
...
--	end
    ...
    if self.zjhroomLayer then
		self.zjhroomLayer:release()
	end
    C.super.exit(self)
end
...
function C:run(transition, time, more)
    ...
    gameManager:checkWaittingUpdateGames()
end
...
function C:didSelectedGame( gameId, animation )
    ...
    --有更新（启动更新）
    print("dataManager:getGameLocalVersion(gameId)----------------------" .. dataManager:getGameLocalVersion(gameId))
...
C.showIndex = 0
--显示充值页面
function C:showRechargeLayer(index)
--	if self.rechargeLayer == nil then
--		self.rechargeLayer = RechargeLayer.new()
--		self.rechargeLayer:retain()
--	end
...
--进入抢庄牛牛房间选择页面
function C:showQZNNRoomLayer()
	require("app.init")
    self:exit()
	QZNNRoomCore.new():run()
end

--进入极速麻将房间选择页面
function C:showJSMJRoomLayer()
	require("app.init")
    self:exit()
	JSMJRoomCore.new():run()
end

--进入看牌抢庄牛牛房间选择页面
function C:showBRQZNNRoomLayer()
	require("app.init")
    self:exit()
	BRQZNNRoomCore.new():run()
end

--进入极速捕鱼房间选择页面
function C:showFishRoomLayer()
	require("app.init")
    self:exit()
	FishRoomCore.new():run()
end

--进入斗地主房间选择页面
function C:showDDZRoomLayer()
	require("app.init")
    self:exit()
	DDZRoomCore.new():run()
end
...
--进入百变斗地主房间选择页面
function C:showCPDDZRoomLayer()
	require("app.init")
    self:exit()
	CPDDZRoomCore.new():run()
end

--进入百人牛牛房间选择页面
function C:showBRNNRoomLayer()
	require("app.init")
    self:exit()
	BRNNRoomCore.new():run()
end

--进入水果机房间选择页面
function C:showFruitRoomLayer()
	require("app.init")
    self:exit()
	FruitRoomCore.new():run()
end

--进入红包扫雷房间选择页面
function C:showHBRoomLayer()
	require("app.init")
    self:exit()
	HBRoomCore.new():run()
end
...
--进入抢庄牌九房间选择页面
function C:showQZPJRoomLayer()
	require("app.init")
    self:exit()
	QZPJRoomCore.new():run()


end--进入三公房间选择页面
function C:showSanGongRoomLayer()
	require("app.init")
    self:exit()
	SanGongRoomCore.new():run()
end
