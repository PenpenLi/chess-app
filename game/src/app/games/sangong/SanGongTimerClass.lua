SanGongTimerClassTypeGameStart = 1  --游戏即将开始
SanGongTimerClassTypeQiangZhuang = 2  --请抢庄
SanGongTimerClassTypeQiangZhuang2 = 3  --抢庄中
SanGongTimerClassTypeXiaZhu = 4  --请投注
SanGongTimerClassTypeXiaZhu2 = 5  --等待其他玩家投注
SanGongTimerClassTypeXiaZhu3 = 6  --投注中
SanGongTimerClassTypeTanpai = 7  --请摊牌
SanGongTimerClassTypeTanpai2 = 8  --摊牌中

local C = class("SanGongTimerClass",ViewBaseClass)
...
function C:show( time, ctype, callback )
    ...
    utils:createTimer("sangong.SanGongTimerClass",1,playtimer)
end

function C:hide()
    utils:removeTimer("sangong.SanGongTimerClass")
    if self.callback then
        self.callback(true,0)
    end
