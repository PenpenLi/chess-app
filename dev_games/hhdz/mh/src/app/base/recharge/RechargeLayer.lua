...
function C:createEditBox(handler)
	...
	local editBox = ccui.EditBox:create(cc.size(402,40),bg,bg,bg)
	editBox:setAnchorPoint(cc.p(0,0.5))
	editBox:setPosition(cc.p(143,239))
	...
	label:setTextColor(cc.c3b(77,77,77))
	label:setTag(10000)
	label:setContentSize(cc.size(350,40))
	label:setPosition(cc.p(201,18))
