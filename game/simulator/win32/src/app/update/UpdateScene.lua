...
C.RESOURCE_BINDING = {
    ...
    --logo_ani_right = {path="logo_ani_right"},
    logo_img = {path="logo_img"},
}
...
function C:initialize()
    ...
    self.logo_img:setPositionX(self.logo_img:getPositionX() + offsetX)

    self:loadLoadingAnimation()
    self.logo_ani_left:setScaleX(0.88)
    self.logo_ani_left:setScaleY(0.88)
--    self.logo_ani_right:setScaleX(0.88)
--    self.logo_ani_right:setScaleY(0.88)
end
...
function C:loadLoadingAnimation()
    local strAnimName ="base/animation/skeleton/loading/loading_effect_element_ske"
...
--    local strAnimName ="base/animation/skeleton/loading/loading_effect_logo_ske"
--    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
--    skeletonNode:setAnimation(0,"biaoti",true)
--    self.logo_ani_right:addChild( skeletonNode )
end
