...
public class Cocos2dxWebView extends WebView {
    ...
    class MyWebChromeClient extends WebChromeClient {
        ...
        public void openFileChooser(ValueCallback<Uri> uploadMsg) {
            ...
            ((Cocos2dxActivity)Cocos2dxActivity.getContext()).setUploadMessage(uploadMsg);
            ((Cocos2dxActivity)Cocos2dxActivity.getContext()).pickImage(1);
        }
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
            ...
            ((Cocos2dxActivity)Cocos2dxActivity.getContext()).setUploadFilePathCallback(filePathCallback);
            ((Cocos2dxActivity)Cocos2dxActivity.getContext()).pickImage(1);
            return true;
        }
    }
