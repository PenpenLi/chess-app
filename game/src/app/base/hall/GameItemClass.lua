...
function C:ctor( node, callback )
	self.node = node
    self.node_nh = self.node:getChildByName("node_nh")
    self.node_qq = self.node:getChildByName("node_qq")
...
function C:getGameInfo( gameId )
	...
	elseif gameId == GAMEID_QZPJ then
		return {path="base/images/main_layer/dt_game_qzpj.png"}
	elseif gameId == GAMEID_SANGONG then
	...
	elseif gameId == GAMEID_BJL then
		return {path="base/images/main_layer/dt_game_bjl.png"}
	else
		return nil
	end
end
...
--炸金花
function C:loadZJHAnimation()
	local strAnimName1 ="base/animation/skeleton/hall/gamehall_hotOrNew_ske"
    local skeletonNode1 = sp.SkeletonAnimation:create(strAnimName1 .. ".json", strAnimName1 .. ".atlas", 1)
    skeletonNode1:setAnimation(0,"Hot",true)        --New
	self.node_nh:addChild( skeletonNode1 )

    self.node_nh:setScaleX(0.88)
    self.node_nh:setScaleY(0.88)

--    local strAnimName2 ="base/animation/skeleton/hall/gamehall_gameItem_ske"
--    local skeletonNode2 = sp.SkeletonAnimation:create(strAnimName2 .. ".json", strAnimName2 .. ".atlas", 1)
--    skeletonNode2:setAnimation(0,"01ZJH",true)
--	self.node_qq:addChild( skeletonNode2 )

--    self.node_qq:setScaleX(1.1)
--    self.node_qq:setScaleY(0.88)
end

--热门
function C:loadHOTAnimation()
	local strAnimName1 ="base/animation/skeleton/hall/gamehall_hotOrNew_ske"
    local skeletonNode1 = sp.SkeletonAnimation:create(strAnimName1 .. ".json", strAnimName1 .. ".atlas", 1)
    skeletonNode1:setAnimation(0,"Hot",true)        
	self.node_nh:addChild( skeletonNode1 )
...
--热门
function C:loadNEWAnimation()
	local strAnimName1 ="base/animation/skeleton/hall/gamehall_hotOrNew_ske"
    local skeletonNode1 = sp.SkeletonAnimation:create(strAnimName1 .. ".json", strAnimName1 .. ".atlas", 1)
    skeletonNode1:setAnimation(0,"New",true)       
	self.node_nh:addChild( skeletonNode1 )
