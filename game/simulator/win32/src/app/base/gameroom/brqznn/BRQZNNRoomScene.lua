...
function C:initialize()
    ...
    self.label_0:setString("底注" .. "1")       --体验房底注
    self.label_1:setString("准入" .. "200")       --体验房准入
    self.label_2:setString("底注" .. "10")       --初级房底注
    self.label_3:setString("准入" .. "1000")       --初级房准入
    self.label_4:setString("底注" .. "50")       --中级房底注
    self.label_5:setString("准入" .. "5000")       --中级房准入
    self.label_6:setString("底注" .. "100")       --高级房底注
    self.label_7:setString("准入" .. "10000")       --高级房准入
    self.label_8:setString("底注" .. "200")       --至尊房底注
    self.label_9:setString("准入" .. "20000")       --至尊房准入
    self.label_10:setString("底注" .. "500")       --王者房底注
    self.label_11:setString("准入" .. "50000")       --王者房准入
