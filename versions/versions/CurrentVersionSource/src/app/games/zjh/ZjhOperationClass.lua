...
C.btnOtherPos = {cc.p(1126,38),cc.p(960,38),cc.p(822,38)}
C.btnGzyzPos = {cc.p(1126,38),cc.p(960,38),cc.p(756,38)}
...
function C:updateBtns( config, isAuto, isMyTurn, isGzyz )
