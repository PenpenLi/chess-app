...
function Cannon:loadUI(uiRoot)
    ...
    self._Player_Node.oldX = self._Player_Node.oldX or self._Player_Node:getPositionX()
    self._Player_Node:setPositionX(self._Player_Node.oldX * Fish2dTools.mWorldScaleRate.x)
