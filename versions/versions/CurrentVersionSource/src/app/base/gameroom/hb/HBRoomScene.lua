...
--    self.label_0:setString("红包限额5-25")       --体验房底注、准入
--    self.label_1:setString("红包限额5-25")       --初级房底注、准入
--    self.label_2:setString("红包限额5-25")       --中级房底注、准入
--    self.label_3:setString("红包限额5-25")       --高级房底注、准入

    self.label_0:setString("红包限额" .. 500/MONEY_SCALE .. "-" .. 2500/MONEY_SCALE)       --体验房底注、准入
    self.label_1:setString("红包限额" .. 500/MONEY_SCALE .. "-" .. 2500/MONEY_SCALE)       --初级房底注、准入
    self.label_2:setString("红包限额" .. 500/MONEY_SCALE .. "-" .. 2500/MONEY_SCALE)       --中级房底注、准入
    self.label_3:setString("红包限额" .. 500/MONEY_SCALE .. "-" .. 2500/MONEY_SCALE)       --高级房底注、准入
