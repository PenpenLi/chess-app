...
function C:show()
	...
	if isGuest then
		...
		self.switchBtn:setPosition(cc.p(148,70))
		self.registerBtn:setPosition(cc.p(409,70))
		self.settingsBtn:setPosition(cc.p(670,70))
	else
		...
		self.switchBtn:setPosition(cc.p(252,70))
		self.settingsBtn:setPosition(cc.p(570,70))
	end
	--屏蔽修改密码
	self.resetBtn:setVisible(false)
end
