...
local C = class("BRQZNNRoomScene",SceneBase)
BRQZNNRoomScene = C
C.qznnHelpLayer = nil
-- 资源名
C.RESOURCE_FILENAME = "base/BRQZNNRoom.csb"
...
function C:initialize()
    ...
    self.label_0:setString("底注" .. 10/MONEY_SCALE)       --体验房底注
    self.label_1:setString("准入" .. 2000/MONEY_SCALE)       --体验房准入
    self.label_2:setString("底注" .. 100/MONEY_SCALE)       --初级房底注
    self.label_3:setString("准入" .. 10000/MONEY_SCALE)       --初级房准入
    self.label_4:setString("底注" .. 500/MONEY_SCALE)       --中级房底注
    self.label_5:setString("准入" .. 50000/MONEY_SCALE)       --中级房准入
    self.label_6:setString("底注" .. 1000/MONEY_SCALE)       --高级房底注
    self.label_7:setString("准入" .. 100000/MONEY_SCALE)       --高级房准入
    self.label_8:setString("底注" .. 2000/MONEY_SCALE)       --至尊房底注
    self.label_9:setString("准入" .. 200000/MONEY_SCALE)       --至尊房准入
    self.label_10:setString("底注" .. 5000/MONEY_SCALE)       --王者房底注
    self.label_11:setString("准入" .. 500000/MONEY_SCALE)       --王者房准入
...
function C:loadQZNNGirlAnimation()
	local strAnimName ="base/animation/skeleton/brqznn/kpqznn_effect_hall_girl_ske"
...
function C:loadQZNN01Animation()
	local strAnimName ="base/animation/skeleton/brqznn/kpqznn_effect_hall_1_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN02Animation()
	local strAnimName ="base/animation/skeleton/brqznn/kpqznn_effect_hall_2_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN03Animation()
	local strAnimName ="base/animation/skeleton/brqznn/kpqznn_effect_hall_3_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN04Animation()
	local strAnimName ="base/animation/skeleton/brqznn/kpqznn_effect_hall_4_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN05Animation()
	local strAnimName ="base/animation/skeleton/brqznn/kpqznn_effect_hall_5_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
...
function C:loadQZNN06Animation()
	local strAnimName ="base/animation/skeleton/brqznn/kpqznn_effect_hall_6_ske"
    local skeletonNode = sp.SkeletonAnimation:create(strAnimName .. ".json", strAnimName .. ".atlas", 1)
    skeletonNode:setAnimation(0,"newAnimation",true)
