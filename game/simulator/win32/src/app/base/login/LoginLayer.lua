...
function C:onCreate()
	...
	self.passwordEditBox:setContentSize(cc.size(214,60))
    local label = self.passwordEditBox:getChildByTag(10000)
    label:setContentSize(cc.size(214,60))
    label:setPosition(cc.p(107,30))
...
function C:createEditBox( placeholder, inputMode )
	...
	local editBox = ccui.EditBox:create(cc.size(352,60),bg,bg,bg)
	editBox:setAnchorPoint(cc.p(0,0.5))
	editBox:setPosition(cc.p(11,35))
	...
	label:setTag(10000)
	label:setContentSize(cc.size(352,60))
	label:setPosition(cc.p(176,30))
