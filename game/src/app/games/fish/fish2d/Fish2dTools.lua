...
Fish2dTools.mGameResPre_C2d = "games/fish"
...
Fish2dTools.mWorldScaleRate = cc.p(display.width / display.height * 750 / 1334, 1)
...
function Fish2dTools.toCCP(x, y)
    return cc.p(x * Fish2dTools.mWorldScaleRate.x, Fish2dTools.kRevolutionHeight * Fish2dTools.mWorldScaleRate.y - y)
end
