...
function C:setHistoryPercent( blackPercent )
	...
	local thumbPosX = 135+430*blackPercent
	self.recentThumbImg:setPositionX(thumbPosX+26)
	self.recentBlackImg:setContentSize(thumbPosX,42)
	self.recentRedImg:setContentSize(700-thumbPosX,42) -- 874-174
	self.recentBlackLabel:setPositionX(thumbPosX-10)
	self.recentRedLabel:setPositionX(thumbPosX+184)
end
