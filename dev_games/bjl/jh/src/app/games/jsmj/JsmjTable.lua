...
function C:ctor(parent, mahjongData)
    ...
    local tableWidth = 884 -- 桌子的实际图片的尺寸
    local tableHeight = 624
    ...
    --牌桌 下
    self:addArea(214, self.tablesize_.width - 984, 444, self.tablesize_.width - 1024, 160, 1, 10, 52)
    --牌桌 右
    ...
    --牌桌 上
    self:addArea(217, self.tablesize_.width - 907, 443,
        self.tablesize_.width - 1123, 393, 0.7, 10, 52 * 0.75)
    --牌桌 左
...
function C:getZ(y, x)
    local z = math.floor(950 - y / self.tablesize_.height * 950)
    if x ~= nil then
