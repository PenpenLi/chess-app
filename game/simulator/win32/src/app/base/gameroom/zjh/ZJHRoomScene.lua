...
--    self.label_7:setString(self.items[4].money/MONEY_SCALE)       --高级房准入  1500     
    ...
    self.label_0:setString("2")       --体验房底注"0.2"
    self.label_1:setString("200")       --体验房准入"20"
    self.label_2:setString("10")       --初级房底注
    self.label_3:setString("500")       --初级房准入
    self.label_4:setString("50")       --中级房底注
    self.label_5:setString("3000")       --中级房准入
    self.label_6:setString("200")       --高级房底注  10 
    self.label_7:setString("15000")       --高级房准入  1500   
