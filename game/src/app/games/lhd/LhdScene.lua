...
function LhdScene:chipMove(score, player, area, call)
    ...
    local chip = cc.Sprite:createWithSpriteFrameName(GAME_LHD_IMAGES_RES.."game/mortgage_fei_"..utils:moneyString(score * 10)..".png");
...
function LhdScene:findChip(playerid, score, areaIndex)
    ...
    if #self.userWinChip[playerid][areaIndex] <= 0 then
        for i = 1, #chipScore do
            local sp = cc.Sprite:createWithSpriteFrameName(GAME_LHD_IMAGES_RES.."game/mortgage_fei_"..utils:moneyString(chipScore[i] * 10)..".png");
...
function LhdScene:createChips(score, area, count)
    ...
    for i = 1, #chipScore do
        local chip = cc.Sprite:createWithSpriteFrameName(GAME_LHD_IMAGES_RES.."game/mortgage_fei_"..utils:moneyString(chipScore[i] * 10)..".png");
        local rotation = math.random(-50, 50);
        chip:setRotation(rotation);
        local chipPosNode = self.chipPos[area];
        local offsetX = chipPosNode:getPositionX();
