...
function C:initialize()
    ...
    self.label_0:setString("底注" .. 20/MONEY_SCALE)       --体验房底注
    self.label_1:setString("准入" .. 2000/MONEY_SCALE)       --体验房准入
    self.label_2:setString("底注" .. 100/MONEY_SCALE)       --初级房底注
    self.label_3:setString("准入" .. 5000/MONEY_SCALE)       --初级房准入
    self.label_4:setString("底注" .. 500/MONEY_SCALE)       --中级房底注
    self.label_5:setString("准入" .. 25000/MONEY_SCALE)       --中级房准入
    self.label_6:setString("底注" .. 1000/MONEY_SCALE)       --高级房底注
    self.label_7:setString("准入" .. 50000/MONEY_SCALE)       --高级房准入
    self.label_8:setString("底注" .. 2000/MONEY_SCALE)       --至尊房底注
    self.label_9:setString("准入" .. 100000/MONEY_SCALE)       --至尊房准入
    self.label_10:setString("底注" .. 3000/MONEY_SCALE)       --王者房底注
    self.label_11:setString("准入" .. 180000/MONEY_SCALE)       --王者房准入
