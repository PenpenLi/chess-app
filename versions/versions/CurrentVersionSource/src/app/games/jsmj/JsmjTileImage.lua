...
function C:createMahjong()
    if self.area_ == JsmjDefine.MahjongPos.POSITION_BOTTOM then -- 手牌下
        self:createPlayerMahjong()
    elseif self.area_ == JsmjDefine.MahjongPos.POSITION_TOP then -- 手牌上
        self:createUpMahjong()
    elseif self.area_ == JsmjDefine.MahjongPos.POSITION_DISCARD_TOP then --牌池上
        self:createDeskDownMahjong()
    elseif self.area_ == JsmjDefine.MahjongPos.POSITION_DISCARD_BOTTOM then --牌池下
        self:createDeskDownMahjong()
    end
end
...
function C:createPlayerMahjong()
    if self.state_ == JsmjDefine.MahjongPos.TILE_SHOW_STATE_STAND then --立起来的手牌
    ...
    elseif self.state_ == JsmjDefine.MahjongPos.TILE_SHOW_STATE_FACE then --明杠牌
