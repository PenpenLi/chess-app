...
--    self.label_0:setString(string.format("%0.1f",string.gsub(self.items[1].name, "底分", "")))       --体验房底注"0.2"
--    self.label_1:setString(self.items[1].money/MONEY_SCALE)       --体验房准入"20"
--    self.label_2:setString(string.format("%0.1f",string.gsub(self.items[2].name, "底分", "")))       --初级房底注
--    self.label_3:setString(self.items[2].money/MONEY_SCALE)       --初级房准入
--    self.label_4:setString(string.format("%0.1f",string.gsub(self.items[3].name, "底分", "")))       --中级房底注
--    self.label_5:setString(self.items[3].money/MONEY_SCALE)       --中级房准入
--    self.label_6:setString(string.format("%0.1f",string.gsub(self.items[4].name, "底分", "")))       --高级房底注  10 
--    self.label_7:setString(self.items[4].money/MONEY_SCALE)       --高级房准入  1500     

    self.label_0:setString(20/MONEY_SCALE)       --体验房底注"0.2"
    self.label_1:setString(2000/MONEY_SCALE)       --体验房准入"20"
    ...
    self.label_5:setString(30000/MONEY_SCALE)       --中级房准入
    self.label_6:setString(2000/MONEY_SCALE)       --高级房底注  10 
    self.label_7:setString(150000/MONEY_SCALE)       --高级房准入  1500   
