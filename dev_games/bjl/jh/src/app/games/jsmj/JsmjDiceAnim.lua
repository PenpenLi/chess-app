...
function C:ctor(parent, width, height)
    ...
    table.insert(self.time_, 0.07)
    table.insert(self.time_, 0.105)
    table.insert(self.time_, 0.245)
    table.insert(self.time_, 0.14)
    table.insert(self.time_, 0.28)
    table.insert(self.time_, 0.42)
