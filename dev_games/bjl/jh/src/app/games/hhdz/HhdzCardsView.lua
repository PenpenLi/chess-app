...
BLACK_CARD_POS = 
{
    {x = display.cx - 195, y = display.top - 52},
    {x = display.cx - 135, y = display.top - 52},
    {x = display.cx - 75, y = display.top - 52}
}
...
function C:createCardsWithAnim( isBlackCard )
	local startPos = cc.p(display.cx, CC_DESIGN_RESOLUTION.height - 52)
	local posArray = nil
