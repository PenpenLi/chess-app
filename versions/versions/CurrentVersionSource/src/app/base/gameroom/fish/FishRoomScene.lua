...
--    self.label_0:setString("X0.02-0.2元")       --入鱼港口房底注
--    self.label_1:setString("准入20元")       --入鱼港口房准入
--    self.label_2:setString("X0.1-1元")       --海王遗迹房底注
--    self.label_3:setString("准入50元")       --海王遗迹房准入
--    self.label_4:setString("X0.2-2元")       --伟大航道房底注
--    self.label_5:setString("准入100元")       --伟大航道房准入

    self.label_0:setString("X"..2/MONEY_SCALE .. "-" .. 20/MONEY_SCALE .. "元")       --入鱼港口房底注
    self.label_1:setString("准入" .. 2000/MONEY_SCALE .. "元")       --入鱼港口房准入
    self.label_2:setString("X"..10/MONEY_SCALE .. "-" .. 100/MONEY_SCALE .. "元")       --海王遗迹房底注
    self.label_3:setString("准入" .. 5000/MONEY_SCALE .. "元")       --海王遗迹房准入
    self.label_4:setString("X"..20/MONEY_SCALE .. "-" .. 200/MONEY_SCALE .. "元")       --伟大航道房底注
    self.label_5:setString("准入" .. 10000/MONEY_SCALE .. "元")       --伟大航道房准入
