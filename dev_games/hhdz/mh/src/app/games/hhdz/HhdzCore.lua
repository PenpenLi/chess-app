...
--    local checkMoney = 0
--    for k,v in pairs(chips) do
--        checkMoney = checkMoney + v * self.model.bets[k]
--    end
--    if srcMoney ~= checkMoney then
--        printError("<==================转换出错了："..srcMoney.."!="..checkMoney.."==================>")
--        printInfo("money:"..money)
--       dump(self.model.bets)
--    end
    return chips
end
