...
function C:initialize()
    ...
    self.label_0:setString("1")       --体验房底注
    self.label_1:setString("200")       --体验房准入
    self.label_2:setString("10")       --初级房底注
    self.label_3:setString("500")       --初级房准入
    self.label_4:setString("50")       --中级房底注
    self.label_5:setString("2000")       --中级房准入
    self.label_6:setString("100")       --高级房底注
    self.label_7:setString("5000")       --高级房准入
