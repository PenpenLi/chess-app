...
function C:onCreate()
    ...
    self.codeEditBox:setContentSize(cc.size(178,60))
    local label = self.codeEditBox:getChildByTag(10000)
    label:setContentSize(cc.size(178,60))
...
function C:createEditBox( placeholder, inputMode )
	...
	local editBox = ccui.EditBox:create(cc.size(348,60),bg,bg,bg)
	editBox:setAnchorPoint(cc.p(0,0.5))
	editBox:setPosition(cc.p(11,33))
	...
	label:setTag(10000)
	label:setContentSize(cc.size(348,60))
