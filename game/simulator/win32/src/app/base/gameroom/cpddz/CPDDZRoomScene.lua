...
local C = class("CPDDZRoomScene",SceneBase)
CPDDZRoomScene = C
C.qznnHelpLayer = nil
-- 资源名
C.RESOURCE_FILENAME = "base/CPDDZRoom.csb"
...
C.RESOURCE_BINDING = {
    ...
    label_money = {path="top_panel.node_account.label_0"},
}

C.offsetX = (display.width-1136)/2

C.items = {}
C.gameId = GAMEID_CPDDZ
...
function C:initialize()
    ...
    self.label_0:setString("准入" .. "10")       --体验房准入
    self.label_1:setString("底分" .. "0.1")       --体验房底分
    self.label_2:setString("准入" .. "100")       --初级房准入
    self.label_3:setString("底分" .. "1")       --初级房底分
    self.label_4:setString("准入" .. "200")       --中级房准入
    self.label_5:setString("底分" .. "2")       --中级房底分
    self.label_6:setString("准入" .. "1800")       --高级房准入
    self.label_7:setString("底分" .. "20")       --高级房底分
