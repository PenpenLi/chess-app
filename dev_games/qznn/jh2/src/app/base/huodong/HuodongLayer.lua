...
local ICON_CONFIGS = {
	...
	[GAMEID_JSYS] = "huodong_popup/icon_game_jsys.png",
	[GAMEID_LHD] = "huodong_popup/icon_game_lhd.png",
	[GAMEID_PDK] = "huodong_popup/icon_game_pdk.png",
...
function C:testData()
	...
	table.insert(list,{Id=2,taskname="跑得快0.2元底分",gameid=GAMEID_PDK,orderid=110,completeVal=10,nowVal=5,completeAmout=1000})
	table.insert(list,{Id=3,taskname="龙虎斗",gameid=GAMEID_LHD,orderid=90,completeVal=20,nowVal=22,completeAmout=2000,finish=1})
	table.insert(list,{Id=1,taskname="金鲨银鲨0.1元底分",gameid=GAMEID_JSYS,orderid=80,completeVal=5,nowVal=2,completeAmout=800})
