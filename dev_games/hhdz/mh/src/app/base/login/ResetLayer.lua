...
function C:onCreate( event )
    ...
    self.codeEditBox:setContentSize(cc.size(220,40))
    local label = self.codeEditBox:getChildByTag(10000)
    label:setContentSize(cc.size(220,40))
...
function C:createEditBox( placeholder, inputMode )
    ...
    local editBox = ccui.EditBox:create(cc.size(395,40),bg,bg,bg)
    editBox:setAnchorPoint(cc.p(0,0.5))
    editBox:setPosition(cc.p(8,35))
    ...
    label:setTag(10000)
    label:setContentSize(cc.size(340,40))
    label:setPosition(cc.p(10,19))
