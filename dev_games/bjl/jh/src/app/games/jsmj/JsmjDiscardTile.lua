...
function C:ctor(parent, pos, isTp)
    ...
    self.doubleMarkWidth_ = self.dimens_:getDimens(15)
    self.doubleMarkMarginTop = -self.dimens_:getDimens(2)
    self.doubleMarkMarginRight = self.dimens_:getDimens(2)
    self.tileThick_ = self.dimens_:getDimens(5)
    self.localtions_ = {}
    self.isTp_ = isTp
    self.callTileId_ = 0
