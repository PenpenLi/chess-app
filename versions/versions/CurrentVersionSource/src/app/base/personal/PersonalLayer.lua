...
function C:show()
	...
	if isGuest then
		...
		self.registerBtn:setPosition(cc.p(506,136))
		self.switchBtn:setPosition(cc.p(248,136))
		self.settingsBtn:setPosition(cc.p(765,136))
	else
		...
		self.switchBtn:setPosition(cc.p(400,136))
		self.settingsBtn:setPosition(cc.p(660,136))
	end
	--屏蔽修改密码
	self.resetBtn:setVisible(false)
end
