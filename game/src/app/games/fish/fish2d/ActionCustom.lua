...
function Action_Move_Point:step(time)
    ...
    local dragon_value = isDntgReverseAtGoStraightBird(cc.p(self._target:getPositionX(),self._target:getPositionY()),newpos)
    ...
    if spr_shadow ~= nil then
        ...
        spr_shadow:setFlippedX(self._target:isFlippedX())
    end
