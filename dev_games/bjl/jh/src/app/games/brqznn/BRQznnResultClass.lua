    ...
    if #losers > 0 then
        ...
        for i,v in ipairs(losers) do
            ...
            for m = 1,num do
                ...
                local timerName = string.format("brqznn.flywin%d_%d",m,i)
    ...
    if #winners > 0 then
        ...
        for i,v in ipairs(winners) do
            ...
            for m = 1,num do
                ...
                local timerName = string.format("brqznn.flylose%d_%d",m,i)
...
function C:flyGold( parent, startPos, endPos, callback, tag )
    local gold = display.newSprite(GAME_BRQZNN_IMAGES_RES.."fly_gold.png")
    gold:setScale(0.7)
    gold:setTag(tag)
...
function C:playFLyGoldSound()
    ...
    -- utils:createTimer("brqznn.QznnFlyGoldTimer",0.4,function()
    --     --播放飞金币音效
    --     PLAY_SOUND(GAME_BRQZNN_SOUND_RES.."coins_fly.mp3")
    -- end)

    -- utils:createTimer("brqznn.QznnFlyGoldTimer2",0.35,function()
    --     --播放飞金币音效
    --     PLAY_SOUND(GAME_BRQZNN_SOUND_RES.."fly_gold.mp3")
    -- end)
end

function C:stopPlayFLyGoldSound()
    utils:removeTimer("brqznn.QznnFlyGoldTimer")
    utils:removeTimer("brqznn.QznnFlyGoldTimer2")
end
